...
Util.inherit(TransformedBoundingBox, BoundingBox, {
  clone: function() {
  ...
  pushTransform: function(t){
    ...
    if(this._t){
      this._t = Util.transform(this._t, t);
    } else {
      this._t = t;
    }
  },
  ...
  addPoint: function(x, y){
    if (this._t) {
      var tf = Util.applyTransform([x||0, y||0], this._t);
      if(!isNaN(x)){
        x = tf[0];
      }
      if(!isNaN(y)){
...
exports.warn = warn;
exports.TransformedBoundingBox = TransformedBoundingBox;
}));
